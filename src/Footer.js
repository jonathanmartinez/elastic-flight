          ...
          <footer className="container-fluid">
            <div className="row">
              <div className="col-xs-12 text-center">
                <div className="link-footer">Coded with <i className="fa fa-heart text-danger"></i> by <a href="https://github.com/jonathanmartinez/elasticflight" target="_blank"> Jonathan Martínez </a></div>
